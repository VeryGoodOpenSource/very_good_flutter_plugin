...
void main() async {
  ...
  const topLevelDirs = [
    'my_plugin',
    'my_plugin/{{#android}}my_plugin_android{{',
    'my_plugin/{{#ios}}my_plugin_ios{{',
    'my_plugin/{{#linux}}my_plugin_linux{{',
    'my_plugin/{{#macos}}my_plugin_macos{{',
    'my_plugin/my_plugin_platform_interface',
    'my_plugin/{{#web}}my_plugin_web{{',
    'my_plugin/{{#windows}}my_plugin_windows{{',
    'my_plugin/.github/workflows/{{#android}}my_plugin_android.yaml{{',
    'my_plugin/.github/workflows/{{#ios}}my_plugin_ios.yaml{{',
    'my_plugin/.github/workflows/{{#linux}}my_plugin_linux.yaml{{',
    'my_plugin/.github/workflows/{{#macos}}my_plugin_macos.yaml{{',
    'my_plugin/.github/workflows/my_plugin_platform_interface.yaml',
    'my_plugin/.github/workflows/my_plugin.yaml',
    'my_plugin/.github/workflows/{{#web}}my_plugin_web.yaml{{',
    'my_plugin/.github/workflows/{{#windows}}my_plugin_windows.yaml{{',
  ];
